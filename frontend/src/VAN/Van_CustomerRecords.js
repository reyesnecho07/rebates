...
function Van_CustomerRecords() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const res = await fetch("http://192.168.100.193:5000/api/van/customer");
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-white/50 shadow-2xl p-8 w-full max-w-[1600px] mx-auto mt-6">
            ...
            <div className="flex items-center gap-4 mb-8 pb-6 border-b border-blue-200">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Manage and view all customer information and records</p>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center flex-wrap gap-4 mb-6">
              <div className="text-sm text-gray-600">
                List of <span className="font-semibold text-blue-600">{filteredCustomers.length}</span> Customers
              </div>
                          ...
                          <div className="text-center py-8 px-6 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div className="relative mb-6">
                              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center shadow-lg animate-pulse">
                                <Users size={36} className="text-blue-500 animate-bounce" />
                              </div>
                              {/* Floating particles */}
                            ...
                            <div className="space-y-3 mb-6">
                              ...
                              <p className="text-gray-600 max-w-md mx-auto leading-relaxed">
                                We couldn't find any customers matching your search criteria. Try adjusting your search terms.
                              </p>
                            </div>
            ...
            {filteredCustomers.length > 0 && (
              <div className="flex justify-between items-center mt-6 flex-wrap gap-4">
                <div className="text-sm text-gray-600">
                  Showing <span className="font-semibold text-blue-600">{((currentPage - 1) * rowsPerPage) + 1}</span> to <span className="font-semibold text-blue-600">{Math.min(currentPage * rowsPerPage, filteredCustomers.length)}</span> of <span className="font-semibold text-blue-600">{filteredCustomers.length}</span> customers
                </div>
