// src/components/Dashboard/NexchemQuotaPerformance.js
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailyData} margin={{ top: 8, right: 12, left: 0, bottom: 16 }}>
                  <defs>
                    <linearGradient id="nexchemColorSales" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <linearGradient id="nexchemLineGradient" x1="0" y1="0" x2="1" y2="0">
                  ...
                  <Area
                    ...
                    dataKey="sales"
                    name="Daily Sales"
                    stroke="url(#nexchemLineGradient)"
                    strokeWidth={2}
                    fill="url(#nexchemColorSales)"
                    fillOpacity={1}
...
export default React.memo(NexchemQuotaPerformance);