...
const VanQuotaPerformance = ({
  ...
  const stats = useMemo(() => {
    ...
    const avgPerActive  = daysWithSales > 0 ? totalSales / daysWithSales : 0;
    return { totalSales, daysWithSales, maxSales, avgPerActive };
  }, [dailyData]);
...
export default VanQuotaPerformance;