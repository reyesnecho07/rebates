...
function Nexchem_ItemRecords() {
  ...
  const routePath = '/Nexchem_ItemRecords';
  ...
  const componentMetadata = {
    name: 'Nexchem_ItemRecords', version: '2.0.0',
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      try {
        const res = await fetch("http://192.168.100.193:3009/api/sync/local/items?db=NEXCHEM_OWN");
